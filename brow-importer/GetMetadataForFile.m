...
//  brow-importer
//
//  Created by Tim Schröder on 28.07.16.
...
Boolean GetMetadataForFile(void *thisInterface, CFMutableDictionaryRef attributes, CFStringRef contentTypeUTI, CFStringRef pathToFile)
{
    ...
    @autoreleasepool {
        ...
        if ([(__bridge NSString *)contentTypeUTI isEqualToString:@"com.timschroeder.brow-helper"]) {
        ...
        } else if ([(__bridge NSString *)contentTypeUTI isEqualToString:@"com.timschroeder.brow-helper"]) {

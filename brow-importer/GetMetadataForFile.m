...
//  brow-importer
//
//  Created by Tim Schröder on 03.07.16.
...
Boolean GetMetadataForFile(void *thisInterface, CFMutableDictionaryRef attributes, CFStringRef contentTypeUTI, CFStringRef pathToFile)
{
    ...
    @autoreleasepool {
        ...
        if ([(__bridge NSString *)contentTypeUTI isEqualToString:@"com.timschroeder.brow"]) {
            ...
            if (error == NULL) {
                ...
                NSObject *contentToIndex = metadata[@"Info"];
        ...
        } else if ([(__bridge NSString *)contentTypeUTI isEqualToString:@"com.timschroeder.brow"]) {
